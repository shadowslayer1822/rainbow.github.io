...
var operationCases = {
  case1: {name: "IQ", price: 5.00, img: "./images/boob.png"},
  case2: {name: "Hibana", price: 0.06, img: "./images/nonnudesweater.jpg"},
  case3: {name: "IQ 2.0", price: 1.32, img: "./images/bomb5.jpg"},
  case4: {name: "IQ 3.0", price: 0.16, img: "./images/nonnudeass.jpg"},
}
...
function caseInfo() {
  $('#caseDisplayImage').attr("src", operationCases[currentCase]["img"]);
